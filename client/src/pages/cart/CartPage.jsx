...
export default function CartPage() {
  const [cartItems, setCartItems] = useState([
    {
      ...
      price: 25000,
      quantity: 1,
      image: "https://i.etsystatic.com/60711025/r/il/7f8a3a/7041645897/il_1588xN.7041645897_nigq.jpg",
    },
    {
      id: 1,
      name: "LiteMate Pro",
  ...
  const formattedDiscount = new Intl.NumberFormat("vi-VN").format(appliedDiscount)
      ...
      <div className="flex flex-col lg:flex-row gap-8">
        ...
        <div className="lg:w-2/3">
          ...
          {cartItems.map((item) => {
            ...
            const itemTotal = selectedItems.includes(item.id) ? item.price * item.quantity : 0
              ...
              <div key={item.id} className="border-t border-gray-200 py-4">
                <div className="grid grid-cols-1 md:grid-cols-12 gap-4 items-center">
                  ...
                  <div className="md:col-span-2">
                    <div className="md:hidden font-medium mb-1">Kích thước & Giá:</div>
                  ...
                  <div className="md:col-span-3">
                    ...
                    <div className="grid grid-cols-[1fr_auto_auto] items-center gap-3">
                      <p className={`font-medium ${selectedItems.includes(item.id) ? "text-black" : "text-gray-400"}`}>
                        {selectedItems.includes(item.id) ? `${formattedItemTotal} VND` : "0 VND"}
                      </p>
          ...
          <div className="bg-white border border-gray-200 rounded-lg shadow-sm p-6">
            {showPayment && shippingMethod === "delivery" ? (
              <div className="text-center">
                ...
                <p className="text-sm text-gray-600 mb-4">Quét mã QR để thanh toán {formattedFinalPrice} VND</p>
                <button
              ...
              <>
                <h2 className="text-2xl text-green-600 font-bold mb-4">Thông Tin Đặt Hàng</h2>
                <h3 className="text-xl font-bold mb-4">Thông Tin Nhận Hàng</h3>
                <div className="mb-4 p-3 bg-green-50 border border-green-200 rounded-md">
                  <p className="text-sm text-green-700">Đã chọn {selectedItems.length} sản phẩm</p>
                </div>
                <form onSubmit={handleSubmit}>
                  <div className="mb-3">
                    ...
                    <input
                      ...
                      className={`block w-full p-2 text-gray-900 border rounded-lg bg-gray-50 text-sm focus:ring-blue-500 focus:border-blue-500 ${errors.name ? "border-red-500" : "border-gray-300"
                        }`}
                    />
                  ...
                  <div className="mb-3">
                    ...
                    <input
                      ...
                      className={`block w-full p-2 text-gray-900 border rounded-lg bg-gray-50 text-sm focus:ring-blue-500 focus:border-blue-500 ${errors.address ? "border-red-500" : "border-gray-300"
                        }`}
                    />
                  ...
                  <div className="mb-3">
                    ...
                    <input
                      ...
                      className={`block w-full p-2 text-gray-900 border rounded-lg bg-gray-50 text-sm focus:ring-blue-500 focus:border-blue-500 ${errors.phone ? "border-red-500" : "border-gray-300"
                        }`}
                    />
                  ...
                  <button
                    ...
                    className={`w-full mt-6 py-3 px-4 rounded-md font-medium transition-colors cursor-pointer ${selectedItems.length === 0
